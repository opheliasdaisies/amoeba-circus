...
class AmoebasControllerTest < ActionController::TestCase
  ...
  test "should create amoeba" do
    assert_difference('Amoeba.count') do
      post :create, amoeba: { act_id: @amoeba.act_id, generation: @amoeba.generation, name: @amoeba.name, talent: @amoeba.talent }
    end
  ...
  test "should update amoeba" do
    patch :update, id: @amoeba, amoeba: { act_id: @amoeba.act_id, generation: @amoeba.generation, name: @amoeba.name, talent: @amoeba.talent }
    assert_redirected_to amoeba_path(assigns(:amoeba))
  end
